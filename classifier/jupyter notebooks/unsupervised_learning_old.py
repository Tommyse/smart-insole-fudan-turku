...
from data_loading import * #importing all functions
...
files = get_files_from_directory(r"data\fall", False)
files += get_files_from_directory(r"data\fast_walk", True)
files += get_files_from_directory(r"data\normal_work", True)
files += get_files_from_directory(r"data\run", True)
