...
permutation_accs, permutation_aucs = SvmClassifiers.testSvmLearning(standardized_data, kern, x_cols, y_cols, permutation_count, True, avg_acc, avg_auc, "svm1_poly")
