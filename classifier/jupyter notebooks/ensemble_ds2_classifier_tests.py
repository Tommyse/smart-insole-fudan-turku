...
avg_acc, real_label, pred_label = Ensemble.testBagging(data, DataColumns.getSelectedCols3())
...
avg_acc, real_label, pred_label = Ensemble.testBagging(data, DataColumns.getSelectedCols4())
...
x_cols = DataColumns.getSelectedCols4()
y_cols = ["label"]
...
avg_acc, real_label, pred_label = Ensemble.testBagging(data, DataColumns.getSelectedCols5())
...
x_cols = DataColumns.getSelectedCols5()
y_cols = ["label"]
...
avg_acc, real_label, pred_label = Ensemble.testBagging(data, DataColumns.getSelectedCols6())
...
x_cols = DataColumns.getSelectedCols6()
y_cols = ["label"]
...
avg_acc, real_label, pred_label = Ensemble.testBagging(data, DataColumns.getSelectedCols7())
...
x_cols = DataColumns.getSelectedCols7()
y_cols = ["label"]
