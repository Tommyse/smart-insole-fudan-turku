...
#Parameters
k = KnnClassifiers.findBestK(data, x_cols, y_cols)

avg_acc, real_label, pred_label = KnnClassifiers.testKnn(data, k, x_cols, y_cols, plots)
...
permutation_accs, permutation_aucs = KnnClassifiers.testKnnLearning(data, k, x_cols, y_cols, permutation_count, True, avg_acc, avg_auc, "knn2_perm")
